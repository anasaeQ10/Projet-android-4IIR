...
public class AuthServiceVolley {
    ...
    private static final String REGISTER_URL = "http://192.168.1.8:8888/expenseTracker/registre.php";
    private static final String LOGIN_URL = "http://192.168.1.8:8888/expenseTracker/login.php";
